        ...
        <AlertDialogContent className="sm:max-w-xl lg:max-w-2xl">
          ...
          <AlertDialogFooter className="sm:flex-row sm:flex-wrap sm:justify-end">
            ...
            <AlertDialogAction
              ...
              className="w-full sm:flex-1 sm:min-w-64 whitespace-normal text-center leading-snug bg-primary text-primary-foreground"
            ...
            <AlertDialogAction
              ...
              className="w-full sm:flex-1 sm:min-w-64 whitespace-normal text-center leading-snug bg-destructive text-destructive-foreground"
              disabled={!deleteTarget || !!isDeletingId}
            >
